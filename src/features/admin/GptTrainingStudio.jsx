...
export const GptTrainingStudio = () => {
  ...
  if (loading) {
    return <div className="text-theme-text-secondary p-8 text-center animate-pulse">Loading GPT Training Studio...</div>;
  }
            ...
            <div className="flex items-start justify-between shrink-0">
              <div>
                ...
                <p className="text-xs text-theme-text-secondary mt-1">
                  Format: JSON or Plain Text. <span className="text-theme-accent-yellow font-medium">This will act as the absolute ground truth for output format for this category.</span>
                </p>
              </div>
            </div>
          ...
          <button 
            ...
            className={`flex items-center gap-2 px-8 py-3 disabled:opacity-80 font-bold rounded-xl transition-all shadow-md transform hover:-translate-y-0.5 active:translate-y-0 ${
              isSaved 
                ...
                : 'bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-theme-text-primary shadow-purple-500/30'
            }`}
          >
            {isSubmitting ? (
              'Saving GPT Example...'
                ...
                <tr key={category} className="hover:bg-[#0B1020]/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right space-x-3 whitespace-nowrap">
                    <button 
                      ...
                      className="text-theme-accent-yellow hover:text-purple-300 font-medium text-xs uppercase"
                    >
                      Edit
                    </button>
                    <button 
