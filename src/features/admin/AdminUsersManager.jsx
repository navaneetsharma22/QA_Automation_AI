  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      <div className="bg-theme-main border border-theme-border rounded-2xl p-6">
        ...
        <form onSubmit={handleCreateUser} className="max-w-xl space-y-5 bg-theme-input p-6 rounded-xl border border-theme-border/50">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-theme-card border border-theme-border rounded-xl pl-10 pr-4 py-2.5 text-sm text-theme-text-primary focus:outline-none focus:border-indigo-500 transition-colors"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 bg-theme-card/50 p-4 rounded-xl border border-theme-border/50">
          ...
          {loading ? (
            ...
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y divide-[#1F2937]">
                {users.map((user) => (
                  <tr key={user.id} className="hover:bg-theme-input/50 transition-colors">
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-theme-main border border-theme-border rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleUpdateUser} className="p-6 space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-theme-input border border-theme-border rounded-xl pl-10 pr-4 py-2.5 text-sm text-theme-text-primary focus:outline-none focus:border-indigo-500 transition-colors"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 bg-theme-input/50 p-4 rounded-xl border border-theme-border">
                  {AVAILABLE_MODULES.map((mod) => (
                    <label key={mod.id} className="flex items-center gap-2 cursor-pointer group">
                      <input
                        type="checkbox"
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-theme-border">
                ...
                <button 
                  type="submit"
                  disabled={isUpdating}
                  className="flex items-center gap-2 px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-theme-text-primary font-medium rounded-xl transition-all shadow-sm"
                >
                  {isUpdating ? 'Saving...' : (
                    <>
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-theme-main border border-red-900/50 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="px-6 py-4 border-b border-theme-border flex items-center justify-between">
              <h3 className="text-lg font-bold text-theme-text-primary flex items-center gap-2">
            ...
            <div className="p-6">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-theme-border">
                ...
                <button 
                  ...
                  disabled={isDeleting}
                  className="flex items-center gap-2 px-6 py-2.5 bg-red-600 hover:bg-red-500 disabled:opacity-50 text-theme-text-primary font-medium rounded-xl transition-all shadow-sm"
                >
                  {isDeleting ? 'Deleting...' : (
                    <>
                      <Trash2 className="w-4 h-4" />
