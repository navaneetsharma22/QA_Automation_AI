  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      <div className="bg-theme-main border border-theme-border rounded-2xl overflow-hidden shadow-xl flex flex-col" style={{ height: 'calc(100vh - 120px)', minHeight: '600px' }}>
        <div className="shrink-0 px-8 py-6 border-b border-theme-border bg-gradient-to-r from-blue-900/20 to-purple-900/10 z-10">
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8">
          ...
          {/* Category Selector */}
          <div className="bg-theme-input border border-theme-border p-6 rounded-xl shadow-inner mb-8 flex items-center justify-between">
            <div>
            ...
            <select
              ...
              className="w-72 bg-theme-main border border-theme-border text-theme-text-primary text-sm rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition-colors cursor-pointer font-bold"
            >
          ...
          <div className="space-y-4">
            ...
            <div className="relative group">
              <textarea 
                ...
                className="w-full min-h-[300px] h-full bg-theme-input border border-theme-border text-theme-text-primary text-sm rounded-xl p-5 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/50 transition-all resize-none shadow-inner font-mono disabled:opacity-50 disabled:cursor-not-allowed"
                spellCheck="false"
              />
            </div>
          </div>
