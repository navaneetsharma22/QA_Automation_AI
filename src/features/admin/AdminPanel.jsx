    ...
    <div className="min-h-screen bg-[#0B1020] text-[#F9FAFB] flex flex-col font-['Inter'] selection:bg-blue-600 selection:text-theme-text-primary">
      ...
      <header className="bg-[#111827] border-b border-[#1F2937] px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-theme-text-primary font-['Plus_Jakarta_Sans'] tracking-tight">Admin Console</h1>
            <p className="text-xs text-theme-text-secondary">Manage QA Platform Settings</p>
          </div>
        </div>
        
        <div className="flex items-center gap-4">
          <span className="text-sm text-theme-text-secondary">
            Logged in as: <strong className="text-theme-text-primary">{adminUser?.username}</strong>
          </span>
          <button 
            ...
            {activeTab === 'dashboard' && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#111827] border border-[#1F2937] rounded-2xl p-6 hover:border-blue-500/30 transition-colors">
                  ...
                  <h3 className="text-lg font-bold text-theme-text-primary mb-2">User Management</h3>
                  <p className="text-sm text-theme-text-secondary">Add, remove, or modify permissions for QA analysts and agents.</p>
                ...
                <div className="bg-[#111827] border border-[#1F2937] rounded-2xl p-6 hover:border-emerald-500/30 transition-colors">
                  ...
                  <h3 className="text-lg font-bold text-theme-text-primary mb-2">Global Settings</h3>
                  <p className="text-sm text-theme-text-secondary">Configure global thresholds, RAG parameters, and API webhooks.</p>
                ...
                <div className="bg-[#111827] border border-[#1F2937] rounded-2xl p-6 hover:border-theme-accent-yellow/30 transition-colors">
                  ...
                  <h3 className="text-lg font-bold text-theme-text-primary mb-2">System Metrics</h3>
                  <p className="text-sm text-theme-text-secondary">Monitor API usage, token limits, and LLM provider latency.</p>
                  <button className="mt-4 text-sm text-theme-accent-yellow hover:text-purple-300 font-medium">View Metrics &rarr;</button>
                </div>
              </div>
            )}
